...
import mdress from "./assects/mens1.png";
    ...
    <div>
            <nav class="nav">
                ...
                <div class="nav-header">
                    ...
                    <div className="menu">
                        <Link to="/mens" className="navbar-button">Mens</Link>
                        <Link to="/womens" className="navbar-button">Womens</Link>
                    </div>
                    </div>
                </div>
                <div class="nav-btn">
      ...
      <div className="main">
        <div className="categry">
          ...
          <div className="catogires">
            <p>Categories</p>
            <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" />
            <label for="vehicle1"> SHORTS</label>
            <br />
            <input type="checkbox" id="vehicle2" name="vehicle2" value="Car" />
            <label for="vehicle2"> TSHIRT</label>
            <br />
            <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat" />
            <label for="vehicle3"> PANTS</label>
            <br />
            <br />
          </div>
          <div className="catogires">
            ...
            <br />
            <input type="checkbox" id="vehicle3" name="vehicle3" value="Boat" />
            <label for="vehicle3"> BLACK</label>
            <br />
            <br />
            <h4>view all</h4>
          </div>
        ...
        <div className="product-card">
          <div className="pic-contain">
            <div>
              <div className="sada">MEN'S WARE</div>
              <div className="underscore1"></div>
            </div>
            <select
            ...
            >
              ...
              <option value="orange">C</option>
              <option value="kiwi">D</option>
            </select>
          </div>
          <div className="pic1">
            <div>
              <div className="content1">
                ...
                <img src={mdress} alt="mens_dress" className="m1"></img>
                <div className="image-container">
                  <img src={plain} alt="wishlist" className="plain"></img>
                  <img src={active} alt="active" className="active"></img>
                </div>
                <div
              ...
              <div className="text">
                ...
                <p className="price-details">
                  RS.2300 <span className="discounted-price">RS.2500</span> 80%
                </p>
              </div>
            </div>
            <div>
                ...
                {modalOpen && (
                  <div className="modal">
                    ...
                    <div className="modal-content">
                      <img src={mdress} alt="mens_dress" className="modalimg" />
                    </div>
                  </div>
                )}
              </div>
                  ...
                  <div className="modal">
                    ...
                    <div className="modal-detail">
                      ...
                      <div className="mcolor">
                        <h4> Avaiable Colors</h4>
                        <div className="color-box">
                          <div class="circle-container0">
                            <div class="circles red"></div>
                            <div class="color-name">Red</div>
                          </div>
                          <div class="circle-container1">
                            <div class="circles black"></div>
                      ...
                      <div className="size">
                        ...
                        <div class="circle-container">
                          <div class="circles black">S</div>
                          <div class="circles red">M</div>
                          <div class="circles black">L</div>
                        </div>
                      </div>
                      <div className="details">
                        ...
                        <div className="button-container">
                          <button class="button add-to-bag">Add to Bag</button>
